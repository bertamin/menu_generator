...
Food.create(name: "Macarrones", existing_amount: "2 paquetes")
Food.create(name: "Queso rallado", existing_amount: "50 gramos")
Food.create(name: "Nata", existing_amount: "1 brik")
Food.create(name: "Tomate", existing_amount: "1 bote")
...
Ingredient.create(recipe_id: 1, food_id: 1, necessary_amount: "1 paquete")